    ...
    <div className="relative min-h-screen bg-light-background dark:bg-dark-background text-light-text dark:text-dark-text overflow-hidden">
      ...
      <main className="relative z-10 px-8 max-w-7xl mx-auto">
        ...
        <section className="py-10">
          <VelocityScroll text="RASYA AKBAR PRATAMA • FULL STACK DEVELOPER • REACT SPECIALIST • " default_velocity={2} className="font-moderniz text-4xl font-bold text-light-heading dark:text-dark-heading" />
        </section>
      </main>
    </div>
  );
